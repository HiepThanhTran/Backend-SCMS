...
<c:url value="/admin/ratings/edit/${rating.id}" var="editRating"/>

<div class="container list">
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="text-center list__title">Chỉnh sửa đánh giá</h1>
    </div>
</div>
...
<form:form id="addRatingForm" method="post" modelAttribute="rating" action="${editRating}">
    <form:hidden path="id"/>

    <div class="form-group">
        <form:label class="form-label" path="rating">Đánh giá</form:label>
        <form:input type="number" name="rating" path="rating" placeholder="Nhập đánh giá" cssClass="form-control"/><br/>
    </div>
