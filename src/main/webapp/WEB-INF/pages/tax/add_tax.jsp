...
<c:url value="/admin/taxs/add" var="addTax" />
...
<form:form id="addTaxForm" method="post" modelAttribute="tax" action="${addTax}">
    <div class="form-group">
        ...
        <form:input type="text" name="rate" path="rate" cssClass="form-control"/><br/>
    </div>

    <div class="form-group">
        <form:label path="region" cssClass="form-label">Rate</form:label>
